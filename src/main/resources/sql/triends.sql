...
create table time_section(
    time_section_id int auto_increment primary key,
    time_section varchar(100)
);
...
alter table course add constraint time_section_course_fk foreign key (time_section_id) references time_section(time_section_id) on delete cascade on update cascade;
